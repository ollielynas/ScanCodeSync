...
pub struct ChangeOutputFolderTask {
...
impl Default for ChangeOutputFolderTask {
    fn default() -> Self {
        Self {
            handle: None, progress: Progress::new_spinner("Change Output Folder"), id: fastrand::u64(0..u64::MAX), finished: false }
    }
}


impl Task for ChangeOutputFolderTask {
